...
image_datasets = {'train': IP102(base_folder=base_folder, transform=data_transforms['train'], train=True),
                'val': IP102(base_folder=base_folder, transform=data_transforms['val'], train=False)   
                }
